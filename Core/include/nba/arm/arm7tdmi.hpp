...
private:
  ...
  #include <nba/arm/handlers/arithmetic.inl>
  #include <nba/arm/handlers/handler16.inl>
  #include <nba/arm/handlers/handler32.inl>
  #include <nba/arm/handlers/memory.inl>
